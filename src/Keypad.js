...
function Keypad({handleClick, handleClear, Calculate, input}){
    return(
        <div className="Keypad">
            ...
            <div className="row">
                <button className="digit" id="end1" onClick={()=>{handleClick("0")}}>0</button>
                <button className="calc" onClick={()=>{Calculate(input)}}>=</button>
                <button className="clear" onClick={()=>{handleClear()}}>C</button>
                <button className="op" id="end2" onClick={()=>{handleClick("+")}}>+</button>
            </div>
        </div>
    )
}
